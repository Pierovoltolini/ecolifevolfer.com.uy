...
    try {
      // CORRECCIÓN 1: fetch usa ruta absoluta
...
      // CORRECCIÓN 2: Ruta absoluta para categories.json
      loadJSON('/data/categories.json'),
      // CORRECCIÓN 3: Ruta absoluta para products.json
...
        // CORRECCIÓN 4: Ruta absoluta para tienda.html
...
            // CORRECCIÓN 5: Ruta absoluta para tienda.html
...
            // if (!c) continue;
            subPanel.appendChild(makeLink(
              // CORRECCIÓN 6: Ruta absoluta para tienda.html
...
          const link = makeLink(
            // CORRECCIÓN 7: Ruta absoluta para tienda.html
            `/tienda.html?cat=${encodeURIComponent(catSlug)}&subcat=${encodeURIComponent(subSlug)}`,
...
    // CORRECCIÓN 8: Ruta absoluta para el fallback
